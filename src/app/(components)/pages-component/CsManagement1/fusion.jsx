            ...
            <Dialog
                ...
                <DialogTitle sx={{ backgroundColor: "#161861", padding: " 8px 8px" }}>
                    <Grid container justifyContent={"space-between"} alignItems={"center"} >
                        <Typography variant='h4' sx={{ color: "#C0FE72" }}>{fusionValue} </Typography>
                ...
                <DialogContent sx={{ backgroundColor: "#639BEB" }}>
                    <Grid container rowGap={5} mt={2} mb={3}>
                        <Grid container alignItems={"center"}>
                            < FaRegMoneyBillAlt color='#fff' size={"22px"} />   <Typography ml={2} variant='h5' color={"#fff"}> Fix Price <span style={{ color: "#161861", fontWeight: 700 }}>$99,000</span> for <span style={{ color: "#161861", fontWeight: 700 }}>4800 kWh</span></Typography>
                        </Grid>
                        <Grid container alignItems={"center"}>
