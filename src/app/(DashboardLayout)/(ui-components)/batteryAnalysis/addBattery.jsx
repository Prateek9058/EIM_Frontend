...
export default function AddUser({ open, setOpen, handleEfficiencyData }) {
    ...
    const onsubmit = async () => {
        ...
        try {
            const response = await axiosInstanceImg.post('/battery/bulkUpload', formData,
                {
            ...
            ><ToastComponent />
                <form onSubmit={handleSubmit(submitDetails)}  >
                                ...
                                <Grid item xs={6} >
                                    <Grid container rowGap={3} >
                                        <TextField
                                            ...
                                            {...register("batteryId", { required: "Battery Id is required!" })}
                    ...
                    <DialogActions sx={{ justifyContent: "center" }}>
                        {file ? <Button size='large' variant='contained' onClick={onsubmit}>Add Battery</Button> : <Button size='large' variant='contained' type='submit'>Add Battery</Button>}
                    </DialogActions>
                </form>
            </Dialog>
        </React.Fragment>
