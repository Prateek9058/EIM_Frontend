...
import {
  dashboardVehicle,
  dashboardScheduling,
} from "@/app/(components)/table/columndata";
...
const Page = () => {
  ...
  const buttons = [{ data: "CS/SS Scheduling" }];
  const Vehicle = [{ button: "View All", data: "Top 10 Performing Vehicles" }];
  const Scheduling = [{ data: "Scheduling Station" }];
