        ...
        <Grid container xs={12} rowGap={2}>
            ...
            <Grid item xs={12}>
                ...
                <Grid container justifyContent={"space-between"}>
                    ...
                    <Grid item >
                    <IconButton variant='contained' ><FaEdit size={"15px"}/></IconButton>
                    </Grid>
                        ...
                        <Box sx={{ width: '100%', typography: 'body1' }}>
                            <TabContext value={value}>
                                <Box sx={{ borderBottom: 1, borderColor: 'divider', backgroundColor: "#0E0147", borderRadius: "16px 16px 0px 0px" }}>
                                    <Typography variant='h3' p={2} sx={{ color: "#fff" }}>Edit Access</Typography>
                                ...
                                {tabs.map((tab) => (
                                    <TabPanel key={tab.value} value={tab.value} sx={{ backgroundColor: "#6099EB", borderRadius: "0px 0px 16px 16px", height: "600px", position: 'relative' }}>
                                        ...
                                        <Grid item xs={12} sx={{ display: 'flex', justifyContent: 'flex-end', p: 2, mt: 20, position: "absolute", bottom: 16, right: 16, }}>
                                            <Button onClick={handleBack} disabled={value === '1'} variant='outlined'>Back</Button>
                                            <Button onClick={handleNext} sx={{ ml: 2 }} variant='contained'>{value === '9' ? "Submit" : "Next"}</Button>
                                        </Grid>
                                    </TabPanel>
                                ))}
                            </TabContext>
