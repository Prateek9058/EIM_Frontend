...
const EnergyEfficiency = () => {
    ...
    const data1 = [
        { content: '20 Vehicle', value: "1", title: "Live CS/SS Load", label: "View report", data: "Distance Traveled" },
        { content: '20 Vehicle', value: "2", title: "CS/SS Status", label: "View report", data: "Trip Payload" },
        { content: '20 Vehicle', value: "3", title: "Charging guns", label: "View report", data: "Trips" }
    ];
    const CSstatus = [
    ...
    const droDownButtons = [
        ...
        { label: "Location", menuItems: ["Location 1", "Location 2", "Location 3"] },
    ...
    return (
        <Grid container spacing={2}>
            ...
            <Grid item xs={12} >
                <ManagementGrid breadcrumbItems={breadcrumbItems} moduleName={"CS/SS Efficiency"} dropDown={droDownButtons} />
            </Grid>
                        ...
                        {item.value === "1" && (
                            <>
                                <Grid container justifyContent="space-between" alignItems="center">
                                    ...
                                    <Button variant='contained' onClick={handleOpenGraph}>View Graph</Button>
                                </Grid>
                                <Gauge
                                    height={180}
                                    innerRadius={"85%"}
                        ...
                        {item.value === "2" && (
                            <>
                                ...
                                {CSstatus.map((item1, index) => (
                                    <Grid key={index} container justifyContent="space-between" sx={{ backgroundColor: item1.color, p: 1.5, border: "1px solid green", mt: 1 }}>
